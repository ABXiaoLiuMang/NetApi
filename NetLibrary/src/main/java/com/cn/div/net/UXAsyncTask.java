...
public abstract class UXAsyncTask<Params, Progress, Result> {
	...
	public static void checkMainThread() {
		if (Looper.getMainLooper() != Looper.myLooper()) {
			throw new IllegalStateException("哥哥们， 不要在线程里面启动 task");
		}
	}
	 ...
	 */
	public final UXAsyncTask<Params, Progress, Result> execute(Params... params) {
	 ...
	 * @see #execute(Object[])
	 */
	public final UXAsyncTask<Params, Progress, Result> executeOnExecutor(
	...
	private static class AsyncTaskResult<Data> {
		final UXAsyncTask mTask;
		final Data[] mData;

		AsyncTaskResult(UXAsyncTask task, Data... data) {
			mTask = task;
			mData = data;
		}
	}
